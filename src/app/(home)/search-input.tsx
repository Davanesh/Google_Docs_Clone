  ...
  return (
    <div className="flex-1 flex items-center justify-center">
      <form className="relative max-w-[720px] w-full" onSubmit={handleSubmit}>
        ...
        />
          <Button type="button" variant='ghost' size="icon" className="absolute left-3 top-1/2 -translate-y-1/2 [&_svg]:size-5 rounded-fully">
            <SearchIcon />
          </Button>
        {value && (
          <Button onClick={handleClear} type="button" variant='ghost' size="icon" className="absolute right-3 top-1/2 -translate-y-1/2 [&_svg]:size-5 rounded-fully">
            <XIcon />
          </Button>
        )}
      </form>
